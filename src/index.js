...
function Square(props) {
  ...
  //className={props.value === 'X' ? 'square red' : 'square yellow'}
  ...
  class Game extends React.Component {
    ...
    render() {
      ...
      const moves = history.map((step, move) => {
        //console.log(step.squareX + ' ' + step.squareY);
  ...
  function calculateWinner(squares) {
   ...
   // console.log(checkHorizontal(squares))
